...
const PlayerInfo = ({ player, color, isTurn, capturedPieces = [], timeRemaining }) => {
    ...
    const activeClass = isTurn
        ? 'ring-2 ring-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.5)] bg-gray-200/80 dark:bg-gray-800/80'
        : 'border border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 opacity-90 dark:opacity-80';

    return (
        <div className={`p-4 rounded-xl backdrop-blur-md transition-all duration-300 text-gray-800 dark:text-white ${activeClass}`}>
            <div className="flex items-center gap-4">
                ...
                <div className="flex-grow min-w-0">
                    <div className="flex justify-between items-center">
                        <h3 className="text-lg font-bold truncate tracking-wide">{player.name}</h3>
            ...
            {capturedPieces.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-1 bg-black/10 dark:bg-black/20 p-2 rounded-lg min-h-[32px]">
            ...
            <div className="grid grid-cols-3 gap-2 mt-4 pt-3 border-t border-gray-300/50 dark:border-gray-700/50">
                ...
                <div className="text-center border-l border-gray-300/50 dark:border-gray-700/50">
